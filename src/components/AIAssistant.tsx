...
import { collection, query, where, orderBy, limit, onSnapshot, doc, addDoc, serverTimestamp, deleteDoc, getDocs } from 'firebase/firestore';
            ...
            <div className="p-8 bg-brand-secondary border-b border-border-light flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button 
                  ...
                  className="p-3 rounded-xl hover:bg-brand-red/10 text-text-muted hover:text-brand-red transition-all disabled:opacity-30"
                  title="Clear Chat"
                >
                  {isClearing ? <Loader2 className="w-5 h-5 animate-spin" /> : <X className="w-6 h-6" />}
                </button>
                <button 
