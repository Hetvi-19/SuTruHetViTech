    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setName(newProfile.displayName);
          setAge('0');
          setGender('other');
          setMedicalHistory('');
        }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4">
          <div className="premium-card p-12 flex flex-col items-center text-center border-4 border-white/40 bg-white/60 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-4xl font-display font-bold text-text-main mb-3">{profile?.displayName || 'User'}</h2>
              ...
              <div className="space-y-4">
                ...
                {isEditing ? (
                  ...
                  <div className="p-6 rounded-[24px] bg-white border border-border-light shadow-sm">
                    <p className="text-2xl font-display font-bold text-text-main">{profile?.displayName || 'Not set'}</p>
                  </div>
                )}
              </div>
